...
const { userImgResize, uploadPhoto } = require("../middleware/uploadImage");
const uploadImageHandler = require("../middleware/UploadImageMidlleware");
...
router.route("/update-user").put(verifyToken, checkRole(['user', 'admin']), uploadImageHandler, updatedUser);
